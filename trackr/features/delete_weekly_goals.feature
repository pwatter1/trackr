...
#     Then I should not be able to delete weekly goal
    
# Scenario: delete a weekly goal that is created
#     Given I am on the dashboard page
#     And the user has has a weekly goal
#     Then I should be able to delete weekly goal