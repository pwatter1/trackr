Feature: delete runninglog
    As a user, 
    So that I can remove my runs, 
    I want my to be able to delete exisiting runs.
...
Scenario: update runninglog
    ...
    Then I should be on the runninglog page
    Then I should see not "Run6"