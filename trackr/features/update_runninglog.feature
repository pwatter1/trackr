Feature: update runninglog
    As a user, 
    So that I can edit my runs, 
    I want my to be able to update exisiting runs.
...
Scenario: update runninglog
    ...
    When I follow "More about Run6"
    Then I should be on the Log Page
    When I follow "Edit"
    Then I should be on the Edit Log Page
    And I fill in "Title" with "ChangedRun"
    And  I press "Update Running Log"
    Then I should see "ChangedRun"